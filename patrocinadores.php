...
<head>
    ...
    <title>Patrocinadores - AETERNA ESPORTS</title>
...
<body>
    ...
    <main class="container page-content">
        <h2 class="section-title reveal-on-scroll">Nuestros Aliados</h2>
        <p style="color:var(--text-sub); margin-bottom: 2rem; padding-left:1rem;" class="reveal-on-scroll">Los socios corporativos que impulsan el desarrollo de AETERNA al máximo nivel del gaming competitivo.</p>
        
        <div class="sponsor-page-grid reveal-on-scroll" style="animation-delay: 0.2s;">
            
            <article class="sponsor-card-lg">
                <i class="fa-brands fa-discord"></i>
                <h3>Discord</h3>
                <p>Nuestra plataforma principal de comunicaciones tanto operativas como para interactuar con todos los fanáticos, hostear torneos de la academia y realizar sorteos.</p>
            </article>

            <article class="sponsor-card-lg">
                <i class="fa-brands fa-twitch"></i>
                <h3>Twitch Europe</h3>
                <p>Partner exclusivo de transmisiones. Todos nuestros programas de análisis de partidos, cobertura en VIVO y transmisiones POV de los jugadores ocurren aquí.</p>
            </article>

            <article class="sponsor-card-lg">
                <i class="fa-brands fa-steam"></i>
                <h3>Valve Network</h3>
                <p>Soporte de servidores Tick-128 con baja latencia reservados en exclusiva para nuestros scrims y prácticas internas previas a Majors.</p>
            </article>

            <article class="sponsor-card-lg">
                <i class="fa-solid fa-microchip"></i>
                <h3>Hardware Sponsor</h3>
                <p>Socio oficial de equipamiento proporcionando procesadores de extrema frecuencia para evitar caídas de FPS bajo humos de CS2 a nivel competitivo.</p>
            </article>
